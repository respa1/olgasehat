    ...
    <div class="flex flex-col lg:flex-row lg:space-x-8">
        ...
        <div class="lg:w-1/3 lg:max-w-sm">
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-2xl p-6 shadow-xl sticky top-24">
                ...
                {{-- Form Bergabung untuk Event --}}
                @if($activity->jenis === 'event' || ($activity->activityType && $activity->activityType->name === 'event'))
                    @if($isJoined)
                        ...
                        @if($participant)
                            <div class="bg-white rounded-lg p-4 mb-6 border border-gray-200">
                                ...
                                @endif
                                <p class="text-sm text-gray-700 mt-3">Nama Peserta: <strong>{{ $participant->nama_peserta }}</strong></p>
                            </div>
                        @endif
                    @else
                    ...
                    @endif
                @else
                    {{-- Untuk Komunitas/Membership tetap pakai link WhatsApp --}}
                    @if($activity->link_kontak)
...
<div id="joinModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 relative">
        ...
        <h3 class="text-2xl font-bold text-gray-900 mb-4">Bergabung dengan Event</h3>

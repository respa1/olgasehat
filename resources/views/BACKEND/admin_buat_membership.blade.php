...
<main class="pt-20 min-h-screen pb-8 px-4 md:px-8 lg:px-10 bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-4xl mx-auto">
        ...
        <p class="text-lg text-slate-600 mt-2 border-b pb-4">Sebagai Super Admin, buat paket membership untuk platform olahraga dan kesehatan.</p>
        ...
        <section class="mt-8">
            <div class="bg-white p-8 rounded-2xl shadow-xl glass border border-slate-100">
                ...
                <form action="{{ route('activities.store.admin') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input name="nama" class="w-full rounded-lg border border-slate-300 p-3 focus:border-sky-500 focus:ring-sky-500" placeholder="Contoh: PREMIUM SPORTS CLUB" required value="{{ old('nama') }}">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="kategori" class="w-full rounded-lg border border-slate-300 p-3 focus:border-sky-500 focus:ring-sky-500" required>
                                ...
                                <option value="Fitness" {{ old('kategori') == 'Fitness' ? 'selected' : '' }}>Fitness</option>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="deskripsi" rows="4" class="w-full rounded-lg border border-slate-300 p-3 focus:border-sky-500 focus:ring-sky-500" placeholder="Tuliskan semua keuntungan yang didapat member, cth: akses semua venue, diskon booking, free coaching" required>{{ old('deskripsi') }}</textarea>
                        </div>
                        ...
                        <div class="md:col-span-2 flex items-center gap-4 pt-4">
                            ...
                            <a href="{{ route('admin') }}" class="border border-slate-300 text-slate-600 hover:bg-slate-100 px-6 py-3 rounded-xl transition duration-200">
                                Batal
                            </a>
                        </div>
                    </div>
                ...
                <div class="membership-card">
                    <div class="flex justify-between items-center mb-4">
                        <h3 class="text-xl font-extrabold flex items-center">
                            <i class="fas fa-crown mr-2 text-yellow-300"></i> PREMIUM SPORTS CLUB
                        </h3>
                        <span class="text-xs font-semibold px-3 py-1 bg-white bg-opacity-20 rounded-full">Platform Olahraga</span>
                    </div>

                    <h2 class="text-2xl font-bold mt-3">Olga Sehat Sports Center</h2>
                    ...
                    <div class="mt-5 space-y-2">
                        ...
                        <div class="flex items-start text-sm"><i class="fas fa-check-circle text-green-300 mr-2 mt-0.5"></i> Akses ke semua venue olahraga</div>
                        <div class="flex items-start text-sm"><i class="fas fa-check-circle text-green-300 mr-2 mt-0.5"></i> Diskon 50% untuk booking lapangan</div>
                        <div class="flex items-start text-sm"><i class="fas fa-check-circle text-green-300 mr-2 mt-0.5"></i> Free coaching dan konsultasi</div>
                        <div class="flex items-start text-sm"><i class="fas fa-check-circle text-green-300 mr-2 mt-0.5"></i> Prioritas akses event dan turnamen</div>
                    </div>
                </div>
            </div>
        </section>

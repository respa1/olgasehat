    ...
    <div class="container">
        <div class="row justify-content-center">
          <div class="col-8">
            <div class="card">
              <div class="card-body">
                <form action="/updateprogram/{{ $data->id }}" method="post">
                  @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="icon" class="form-control" value="{{ old('icon', $data->icon) }}" placeholder="Contoh: fas fa-handshake" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control" rows="4" placeholder="Masukkan deskripsi program" required>{{ old('description', $data->description) }}</textarea>
                </div>

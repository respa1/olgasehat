...
<main class="pt-20 min-h-screen pb-8 px-4 md:px-8 lg:px-10 bg-gradient-to-br from-gray-50 to-gray-100">
    <div class="max-w-4xl mx-auto">
        ...
        <p class="text-lg text-slate-600 mt-2 border-b pb-4">Sebagai Super Admin, buat komunitas olahraga untuk mempromosikan aktivitas sehat di platform.</p>
                ...
                <form action="{{ route('activities.store.admin') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input name="nama" class="w-full rounded-lg border border-slate-300 p-3 focus:border-sky-500 focus:ring-sky-500" placeholder="Contoh: Komunitas Olahraga Nasional" required value="{{ old('nama') }}">
                        </div>
                        <div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="deskripsi" rows="4" class="w-full rounded-lg border border-slate-300 p-3 focus:border-sky-500 focus:ring-sky-500" placeholder="Tulis ringkasan komunitas, jadwal, manfaat, dan informasi penting lainnya" required>{{ old('deskripsi') }}</textarea>
                        </div>
